...
public class AmericanFootballActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTheme(R.style.AmericanFootTheme);
     ...
     */
    public void bt_TouchdownA(View view){
     ...
     */
    public void bt_FieldGoalA(View view){
     ...
     */
    public void bt_ExtrapointA(View view){
     ...
     */
    public void bt_TouchdownB(View view){
     ...
     */
    public void bt_FieldGoalB(View view){
     ...
     */
    public void bt_ExtrapointB(View view){
...
//        startActivity(intent);
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, "American_Football_Results");
